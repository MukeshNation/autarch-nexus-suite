...
export const Route = createFileRoute("/admin_/team")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Support team · Autarch AI admin" },
      { property: "og:description", content: "Owner-only management of Autarch AI support agents, managers and read-only analysts." },
